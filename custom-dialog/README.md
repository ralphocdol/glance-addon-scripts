...
```html
  ...
  <link rel="preload" href="/assets/path-to-addon-script/custom-dialog/style.css?v=1" as="style" onload="this.onload=null;this.rel='stylesheet'">
  <script defer src="/assets/path-to-addon-script/custom-dialog/script.js?v=1"></script>
```
