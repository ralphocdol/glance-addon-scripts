      ...
      children: [{
        ...
        datasets: {
          ...
          ...(mobile && {
            ...
            popoverAnchor: '.custom-menu-button',
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    function createCustomMenuItemElement(params) {
      ...
      if (!className || !tooltip || !icon || !actionFn) {
        ...
        (_window$showToast3 = (_window4 = window).showToast) === null || _window$showToast3 === void 0 || _window$showToast3.call(_window4, 'Missing required parameters, see logs.', {
          title: 'CUSTOM MENU',
          type: 'error'
        });
    ...
    setTimeout(() => {
      ...
      menuList.sort((a, b) => (Number.isFinite(a.order) ? a.order : Infinity) - (Number.isFinite(b.order) ? b.order : Infinity) || a.className.localeCompare(b.className)).forEach(({
        className,
        tooltip,
        icon,
        actionFn,
      ...
      if (hasColumns) glanceNativeToTopEl.remove();else glanceNativeToTopEl.style.display = 'flex';
    }, 500);
  });
})();