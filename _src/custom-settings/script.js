...
document.addEventListener('DOMContentLoaded', async () => {
  var _window, _window$GLANCE_ADDON_, _window$createCustomM, _window6;
  ...
  const navBottom = createElementFn({
    classes: 'nav-bottom'
  });
  ...
  function generateTemplateFunction(events) {
    ...
    return function (_KEY_) {
      ...
      const _SET_KEYED_ELEMENT_ = (key, properties) => Object.assign(_KEYED_ELEMENT_(key), {
        ...properties
      });
  ...
  function buildFetchUrl(target) {
    try {
      ...
      var _window4;
      (_window4 = window) === null || _window4 === void 0 || _window4.showToast('Invalid URL, see logs.', {
        title: 'Theming',
        type: 'error'
      });
  ...
  setTimeout(() => {
    settingsList.sort((a, b) => (Number.isFinite(a.order) ? a.order : Infinity) - (Number.isFinite(b.order) ? b.order : Infinity) || a.name.localeCompare(b.name)).forEach(s => {
      const {
        name = '',
        contentObject = {},
      ...
      const templateScript = createElementFn({
        tag: 'template',
        datasets: {
          scriptId: contentPair
        }
      });
      templateScript.content.appendChild(document.createTextNode(generateTemplateFunction(contentEventListener)));
      const contentElement = createElementFn({
        datasets: {
          content: contentPair
        }
      ...
      contentElement.appendChild(generateSettingsWidgets({
        key: contentPair,
        contentObject
      }));
    ...
    const fragment = createElementFn({
      ...
      children: [{
        ...
        children: [{
          ...
          style: {
            height: (widget === null || widget === void 0 ? void 0 : widget.height) || '300px'
          }
        }, labelElSpec]
      }, {
        classes: 'textarea-actions',
        children: [{
          htmlContent: (widget === null || widget === void 0 ? void 0 : widget.additionalInfo) || ''
        }, {
          classes: 'more-btns',
          children: [...(((_widget$moreButtons = widget.moreButtons) === null || _widget$moreButtons === void 0 ? void 0 : _widget$moreButtons.map(b => ({
            tag: 'button',
            classes: 'btn',
            attrs: {
              title: b.tooltip
            ...
            htmlContent: (widget === null || widget === void 0 ? void 0 : widget.customButton) || `${btnSaveSvg} SAVE`
          }]
        }]
      }]
    });
  ...
  function elementButtons(widget) {
    const fragment = createElementFn({
      ...
      children: [...widget.buttons.map(b => ({
        ...
        style: {
          background: b.negative ? 'var(--color-negative)' : ''
        },
        textContent: b.name
      }))]
    });
  ...
  function elementSlider(widget, extraEl) {
    ...
    const fragment = createElementFn({
      ...
      children: [{
        ...
        children: [labelElSpec, {
          tag: 'label',
          datasets: {
            sliderLabel: widget.key
          },
        ...
        events: {
          ...(!(widget !== null && widget !== void 0 && widget.disableMouseWheel) && {
            wheel: {
              handler: sliderWheel,
              options: {
                passive: false
  ...
  function generateSettingsWidgets({
    ...
    const widgetContainer = createElementFn({
      tag: 'section',
      classes: key
    });
    contentObject.forEach(widget => {
      var _window$showToast3, _window5;
      widget.maxLength = widget.maxLength || null;
      const widgetElement = createElementFn({
        classes: 'custom-settings-content-card'
      });
      if (widget !== null && widget !== void 0 && widget.style) Object.assign(widgetElement.style, widget.style);
      if (widget !== null && widget !== void 0 && widget.colOffset) widgetElement.style.gridColumn = `1 / -${widget.colOffset}`;
      ...
      const buttonElSpec = {
        ...
        htmlContent: (widget === null || widget === void 0 ? void 0 : widget.icon) || btnSaveSvg
      };
      switch (widget.type) {
        case 'toggle':
          {
        ...
        case 'text':
          {
            ...
            widgetElement.appendChild(elementText(widget, {
              buttonElSpec,
              labelElSpec
            }));
            break;
        ...
        case 'dropdown':
          {
            ...
            widgetElement.style.gap = '1rem';
            widgetElement.appendChild(elementDropdown(widget, {
              labelElSpec
            }));
            break;
          }
        case 'multi-text':
          {
            ...
            widgetElement.style.gap = '1rem';
            widgetElement.appendChild(elementMultiText(widget, {
              buttonElSpec,
              labelElSpec
            }));
            break;
        ...
        case 'textarea':
          {
            ...
            widgetElement.style.gap = '1rem';
            widgetElement.appendChild(elementTextarea(widget, {
              labelElSpec
            }));
            break;
          }
        ...
        case 'slider':
          {
            ...
            widgetElement.appendChild(elementSlider(widget, {
              labelElSpec
            }));
            break;
          }
        default:
          ...
          (_window$showToast3 = (_window5 = window).showToast) === null || _window$showToast3 === void 0 || _window$showToast3.call(_window5, noEl, {
            type: 'error'
          });
          console.error(noEl);
      }
